...
Since statistical estimation is a method of inference, we need to weigh validity evidence the same way we did for tests of hypotheses. Whether the estimate is a "good" estimate depends on how the sample was drawn. If a biased method of drawing the sample was used, or a biased method of assigning participants to groups was used, the compatibility interval will likely be biased. Let's again illustrate using our key example.
