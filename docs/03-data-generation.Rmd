...
In the in-class activity, *Generating Random Data*, you will create several probability models to generate data about cats. To prepare for this activity, watch the [Probability Simulation](http://www.tinkerplots.com/movies/probability-simulation) TinkerPlots&trade; tutorial video.
